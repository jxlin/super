...
class ActionLayer(BaseActionLayer):
    ...
    def _inconsistent_effects(self, actionA, actionB):
        ...
        effectSetA, effectSetB = self.children[actionA], self.children[actionB]
        for effectA in effectSetA:
            for effectB in effectSetB:
                if effectA == ~effectB:
                    return True
        return False
    ...
    def _interference(self, actionA, actionB):
        ...
        # TODO: implement this function
        effectSetA, effectSetB = self.children[actionA], self.children[actionB]
        preconditionSetA, preconditionSetB = self.parents[actionA], self.parents[actionB]
        for effectA in effectSetA:
            for preconditionB in preconditionSetB:
                if effectA == ~preconditionB:
                    return True
        for effectB in effectSetB:
            for preconditionA in preconditionSetA:
...
class LiteralLayer(BaseLiteralLayer):
    ...
    def _inconsistent_support(self, literalA, literalB):
        ...
        """
        # TODO: implement this function
        actionSetA, actionSetB = self.parents[literalA], self.parents[literalB]
        for actionA in actionSetA:
            for actionB in actionSetB:
